...
function createStyles(c: Palette) {
  return StyleSheet.create({
    ...
    // Apple specifies this button's look: black fill, white label, the Apple
    // logo, and a height matching the buttons beside it. It does not follow
    // the app's palette, in either appearance.
    apple: {
...
const lightTheme: AppTheme = {
  s: createStyles(lightColors),
  colors: lightColors,
  isDark: false,
};
const darkTheme: AppTheme = {
  s: createStyles(darkColors),
  colors: darkColors,
  isDark: true,
};
